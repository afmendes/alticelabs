filter_rr MATLAB Python Package
...
2. Installing the filter_rr Package

A. Change to the directory that contains the file setup.py and the subdirectory 
filter_rr. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the filter_rr Package

The filter_rr package is on your Python path. To import it into a Python script or 
session, execute:
