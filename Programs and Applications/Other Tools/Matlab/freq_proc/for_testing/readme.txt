freq_proc MATLAB Python Package
...
2. Installing the freq_proc Package

A. Change to the directory that contains the file setup.py and the subdirectory 
freq_proc. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the freq_proc Package

The freq_proc package is on your Python path. To import it into a Python script or 
session, execute:
