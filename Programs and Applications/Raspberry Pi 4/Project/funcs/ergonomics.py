...
def _coprocessor(firebase: Firebase, seat_block: SeatBlock, back_block: BackBlock, seat_sensor: str):
    ...
    try:
        while True:
            ...
            #means of values from the FSR's
            back_data_mean = [
            ...
            #means of values from the seat sensors
            seat_data_mean = [
            ...
            #sends to the database the means of values from the FSR's and from the seat sensors
            _send_data(firebase, back_data_mean, seat_data_mean)
    except Exception as e:
        print(e)
        start_ergonomics(seat_sensor)

# function that sens data to the database with the time from when its sent
            ...
            if seat_sum < 5:
                ...
                if back_sum < 1000:
                    ...
                    # Lower back not in the right position
                        ...
                        position = 1
            #array with the numbers and description of
            positions = [
